...
def nested_loop(iterable, cols1, col2, local_data_train, data_orig_test, percentage_list, imputation_types, imputation_type2, Classification_Models, results_df, privileged_sex, privileged_race):
        ...
        for percentage in percentage_list:
            ...
            for imputer in imputation_types:
                ...
                for classifier in Classification_Models:
                    ...
                    Percent_Deleted = percentage
                    imputation_strategy = imputer
                    ...
                    new_row = ['Adult', i, percentage, imputation_strategy, 1, classifier.__class__.__name__,
                               Accuracy,
                               AUC, F1_score, Sensitivity, Specificity, Statistical_Parity_Race, Statistical_Parity_Sex,
                               Equal_Oppr_diff_Race, Equal_Oppr_diff_Sex, average_abs_odds_diff_Race,
                               average_abs_odds_diff_Sex,
                               Disparate_Impact_Race, Disparate_Impact_Sex, Theil_Index_Race, Theil_Index_Sex]
                    results_df.loc[len(results_df)] = new_row
    return results_df


def nested_loop2(iterable, cols1, col2, local_data_train, data_orig_test, percentage_list, imputation_types, imputation_type2, Classification_Models, results_df5, privileged_sex, privileged_race):
    results_df_names = ['dataset_name', 'num_columns_imputed', 'percentage_deleted', 'imputation_strategy',
                        'repetition',
                        'classification_algorithm', 'accuracy', 'auc', 'F1_score', 'Sensitivity', 'Specificity',
                        'Statistical_Parity_Race', 'Statistical_Parity_Sex', 'Equal_Oppr_diff_Race',
    ...
    for i in range(1, len(cols1) + 1):
        random_columns = np.random.choice(cols1, i, replace=False)
        local_data = local_data_train.copy(deep=True)
        ...
        for percentage in percentage_list:
            ...
            for imputer in imputation_types:
                ...
                for classifier in Classification_Models:
                    ...
                    new_row = ['Adult_Cat', i, percentage, imputation_strategy, iterable, classifier.__class__.__name__,
                               Accuracy, AUC, F1_score, Sensitivity, Specificity,
                               Statistical_Parity_Race, Statistical_Parity_Sex, Equal_Oppr_diff_Race,
                               Equal_Oppr_diff_Sex, average_abs_odds_diff_Race, average_abs_odds_diff_Sex,
                               Disparate_Impact_Race, Disparate_Impact_Sex, Theil_Index_Race, Theil_Index_Sex]
