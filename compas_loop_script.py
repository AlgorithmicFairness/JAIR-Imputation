        ...
        for percentage in percentage_list:
            ...
            for imputer in imputation_types:
                if imputer in imputation_type2:
                    local_data_final = imputer.fit_transform(local_data)
                else:
                ...
                for classifier in Classification_Models:
                    ...
                    #                 Num_of_Columns = len(random_columns)
                    ...
                    new_row = ['Compas', i, percentage, imputer.__class__.__name__, 1, classifier.__class__.__name__,
        ...
        for percentage in percentage_list:
            ...
            for imputer in imputation_types:
                ...
                for classifier in Classification_Models:
                    ...
                    new_row = ['Compas_Cat', i, percentage, imputation_strategy, iterable, classifier.__class__.__name__,
                               Accuracy, AUC, F1_score, Sensitivity, Specificity,
                               Statistical_Parity_Race, Statistical_Parity_Sex, Equal_Oppr_diff_Race,
